...
const Banner = () => {
    return (
        <div className='banner-bg mt-5 p-8 rounded-lg'>
            ...
            <div className="hero p-10">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        ...
                        <p className="py-6 lg:text-white lg:text-xl"> Hey good people, <br />Here we are create a impressive website where you can find a lots of used mobile. <br />We have a lots of collection. <br />Chose the desire mobile and put it on your pocket</p>
