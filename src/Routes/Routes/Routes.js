...
const router = createBrowserRouter([
    ...
    children: [
        ...
        },
        {
            ...
            loader: ({params}) => fetch(`https://assignment-12-server-mu.vercel.app/products/${params.category}`)
        },
    ]
},
{
    ...
    children: [
        ...
        },
        {
            ...
            loader: ({params}) =>  fetch(`https://assignment-12-server-mu.vercel.app/payments/${params.id}`)
        },
    ]
}
]);
